                    ...
                    <div class="page-content__container__content__setting__control">
                        <div class="controls">
                            ...
                            <div class="controls__actions">
                                <div class="keypad">
                                    <span  class="search-bar__input">W</span>
                                </div>
                                <div class="keypad">
                                    <span class="material-icons-round button__icon-right">arrow_upward</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="controls">
                            ...
                            <div class="controls__actions">
                                <div class="keypad">
                                    <span  class="search-bar__input">S</span>
                                </div>
                                <div class="keypad">
                                    <span class="material-icons-round button__icon-right">arrow_downward</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="page-content__container__content__setting__control">
                        <div class="sound-toggle">
                            ...
                            <div class="sound__actions">
                                <div class="sound__actions__toggle">
                        ...
                        <div class="sound-toggle">
                            ...
                            <div class="sound__actions">
                                <div class="sound__actions__toggle">
                                    <input type="checkbox" id="sound-effects" name="sound-effects" value="sound-effects">
