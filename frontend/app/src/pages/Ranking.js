...
const loadingBasePage = () => {
	return `
		<div class="page-content__container__header">
			...
			<button onclick="openModal('modalshareRanking')"class="button button--secondary">
		...
		<div class="modal modal--share-ranking-one" id="modalshareRanking">
        <div class="share-ranking__header">
            ...
            <div class="icon-sharing" id="closeIcon">
                <span onclick="closeModal('modalshareRanking')" class="material-icons-round button__icon-right">close</span>
            </div>
        </div>
        <div class="share-ranking__content">
            <div class="share-ranking__content__info">
                <div class="share-ranking__content__info__player">
                    <div class="share-ranking__content__info__player__text">
                        <h1 class="share-ranking__content__info__player__text__place">#1 Place</h1>
                    ...
                    <div class="share-ranking__content__info__player__container">
                        <img class="share-ranking__content__info__player__container__image" src="../assets/images/players/tomatte.png" alt="avatar">
            ...
            <div class="share-ranking__content__illustration">
                <img id="trophyImage" src="../assets/images/tournament/medal-dynamic-color.png" alt="trophy">
            </div>
        </div>
    </div>
