const Ranking = () => {
    ...
    pageContentContainer.innerHTML = `
        ...
        <table class="ranking-table">
            ...
            <tr class="table-row">
                <td class="table-row__data-rank font-body-large">#2</td>
                <td class="table-row__player">
                    <img class="table-row__player__image" src="../assets/images/players/caos.png" alt="player">
                    <div class="table-row__player__text">
                        <span class="table-row__player__text__name font-body-medium-bold">Caos Lourenc</span>
            ...
            <tr class="table-row">
                <td class="table-row__data-rank font-body-large">#3</td>
                <td class="table-row__player">
                    <img class="table-row__player__image" src="../assets/images/players/player3.png" alt="player">
                    <div class="table-row__player__text">
                        <span class="table-row__player__text__name font-body-medium-bold">Player 3</span>
                        <span class="table-row__player__text__nickname font-body-regular">player3</span>
                    </div>
                </td>
                <td class="table-row__data-default font-body-medium-bold">98</td>
                <td class="table-row__data-default font-body-medium-bold">75</td>
                <td class="table-row__data-default font-body-medium-bold">20</td>
                <td class="table-row__data-default font-body-medium-bold">72%</td>
                <td class="table-row__data-default font-body-medium-bold">28%</td>
                <td class="table-row__actions">
                    <button class="button button--success">
                        <span class="button__text font-body-regular-bold">Add friend</span>
                    </button>
            ...
            <tr class="table-row">
                <td class="table-row__data-rank font-body-large">#4</td>
                <td class="table-row__player">
                    <img class="table-row__player__image" src="../assets/images/players/player4.png" alt="player">
                    <div class="table-row__player__text">
                        <span class="table-row__player__text__name font-body-medium-bold">Player 4</span>
                        <span class="table-row__player__text__nickname font-body-regular">player4</span>
                    </div>
                </td>
                <td class="table-row__data-default font-body-medium-bold">95</td>
                <td class="table-row__data-default font-body-medium-bold">78</td>
                <td class="table-row__data-default font-body-medium-bold">18</td>
                <td class="table-row__data-default font-body-medium-bold">68%</td>
                <td class="table-row__data-default font-body-medium-bold">32%</td>
                <td class="table-row__actions">
                    <button class="game-row-option">
                        <span class="material-icons-round game-row-option__icon">sports_esports</span>
                    </button>
